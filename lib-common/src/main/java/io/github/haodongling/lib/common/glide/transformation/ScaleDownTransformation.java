...
public class ScaleDownTransformation extends BitmapTransformation {
    ...
    public ScaleDownTransformation() {
        maxWidth = PixUtils.getScreenWidth();
        maxHeight = PixUtils.getScreenHeight();
    }
    ...
    protected Bitmap transform(@NonNull BitmapPool pool, @NonNull Bitmap toTransform, int outWidth, int outHeight) {
        ...
        mCanvas.drawBitmap(toTransform, new Rect(0, 0, toTransform.getWidth(), toTransform.getHeight()), new Rect(0, 0, sw, sh), null);
        return output;
    }
